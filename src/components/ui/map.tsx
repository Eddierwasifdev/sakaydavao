...
const defaultStyles = {
  // Use Voyager for both to keep all detailed POIs and labels. We apply a CSS filter for dark mode natively in index.css
...
function MapRoute({
  ...
  useEffect(() => {
    ...
    // Guard against source/layer already existing (e.g. React StrictMode double-mount)
